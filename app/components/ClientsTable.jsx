...
export default function ClientsTable() {
  ...
  const [editedData, setEditedData] = useState({ id: "", age: "" });
  ...
  // Edit
  const handleEditClick = (id, currentAge) => {
    setEditingRow(id);
    setEditedData({ id, age: currentAge });
  };
            ...
            {filteredClients.map((client, index) => (
              <motion.tr
                ...
                className={`hover:bg-[#1e1e1e] transition-colors duration-300 ${
                  editingRow === client.id ? "bg-[#2f2f2f]" : ""
                }`}
              >
                  ...
                  <div className="flex space-x-2">
                    {editingRow === client.id ? (
                      ...
                      <button
                        ...
                        title="Edit client"
                        onClick={() => handleEditClick(client.id, client.age)}
                      >
                        <Edit size={18} />
                      </button>
                    )}
